...
export const CWS_TAP = 'CWS_TAP' // quick tap of CWS — disengages the autopilot (§5.2.2)
export const CWS_PRESS = 'CWS_PRESS' // CWS held — enters CWS mode (§5.4.7)
export const CWS_RELEASE = 'CWS_RELEASE' // CWS released after a hold
...
export const cwsTap = () => ({ type: CWS_TAP })
